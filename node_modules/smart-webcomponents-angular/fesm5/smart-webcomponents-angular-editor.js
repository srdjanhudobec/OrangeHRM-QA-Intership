...
var EditorComponent = /** @class */ (function (_super) {
    ...
    */
    EditorComponent.prototype.addToolbarItem = function (itemName) {
        var _this = this;
        if (this.nativeElement.isRendered) {
            ...
            this.nativeElement.whenRendered(function () {
                _this.nativeElement.addToolbarItem(itemName);
            });
        }
    };
  ...
  */
    ...
    */
    EditorComponent.prototype.insertToolbarItem = function (itemName, index) {
        var _this = this;
        if (this.nativeElement.isRendered) {
            ...
            this.nativeElement.whenRendered(function () {
                _this.nativeElement.insertToolbarItem(itemName, index);
            });
        }
    };
  ...
  */
    ...
    * @param {number} index. The toolbar item's index
    */
    EditorComponent.prototype.removeToolbarItem = function (index) {
        var _this = this;
        if (this.nativeElement.isRendered) {
            ...
            this.nativeElement.whenRendered(function () {
                _this.nativeElement.removeToolbarItem(index);
            });
        }
    };
