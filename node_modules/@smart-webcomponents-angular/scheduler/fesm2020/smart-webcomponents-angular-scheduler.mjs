...
class SchedulerComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
  ...
  */
    ...
    * @returns {string}
  */
    async getDateFromCoordinates(x, y) {
        const getResultOnRender = () => {
            return new Promise(resolve => {
                this.nativeElement.whenRendered(() => {
    ...
    * @returns {boolean}
  */
    async getIsAllDayCellFromCoordinates(x, y) {
        const getResultOnRender = () => {
            return new Promise(resolve => {
                this.nativeElement.whenRendered(() => {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: SchedulerComponent, decorators: [{
            ...
            args: [{
                ...
                type: Input
            }], hideNonworkingWeekdays: [{
                type: Input
            }], hideOtherMonthDays: [{
                type: Input
            }], hideTodayButton: [{
                type: Input
            }], hideViewMenuCheckableItems: [{
                type: Input
            }], hideWeekend: [{
                type: Input
            }], legendLocation: [{
...
SchedulerModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: SchedulerModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
SchedulerModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: SchedulerModule, declarations: [SchedulerComponent], exports: [SchedulerComponent] });
SchedulerModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: SchedulerModule });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: SchedulerModule, decorators: [{
            type: NgModule,
            args: [{
...
export { SchedulerComponent, SchedulerModule, Smart };
//# sourceMappingURL=smart-webcomponents-angular-scheduler.mjs.map
